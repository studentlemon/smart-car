...
//tft控制端口
#define	LCD_CS_SET      PTB3_OUT=1    //片选端口  	  
#define	LCD_RS_SET	PTB8_OUT=1    //数据/命令     	   
#define	LCD_WR_SET	PTB2_OUT=1    //写数据			  
#define	LCD_RD_SET	PTB9_OUT=1    //读数据			 
								    
#define	LCD_CS_CLR      PTB3_OUT=0     //片选端口  
#define	LCD_RS_CLR	PTB8_OUT=0     //数据/命令      
#define	LCD_WR_CLR	PTB2_OUT=0     //写数据			  
#define	LCD_RD_CLR	PTB9_OUT=0     //读数据
