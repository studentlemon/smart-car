...
uint8 AngleAcceleration_AD(uint16_t *AdColle,uint8_t Count)
{
  ...
  //   AdColle[0] += ad_sum(ADC1,AD13, ADC_12bit, ADCOUT) ;  //ZG源程序
     AdColle[2] += ad_sum(ADC0, AD12, ADC_12bit, ADCOUT) ;  //YG源程序
     AdColle[3] += ad_sum(ADC0, AD13, ADC_12bit, ADCOUT) ;  //xG源程序 
