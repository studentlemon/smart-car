...
extern void DMA_PORTx2BUFF_Init(DMA_CHn CHn, void *SADDR, void *DADDR, PTxn ptxn, DMA_BYTEn byten, uint32 count, DMA_PORTx2BUFF_cfg cfg) ;

extern void DMA_count_Init(DMA_CHn CHn, PTxn ptxn, uint32_t count, DMA_PORTx2BUFF_cfg cfg);
extern uint32_t  DMA_count_get(DMA_CHn CHn);
